...
void main()
{
	...
	//Vertical plane
	objectPosition.z+=sin(a_Position.x+u_Time*1)*0.5;
	...
	uvOffset.x+=sin((a_Position.y+u_Time)+0.5)/40;//Animate the texture, multiply inside parentheses to control speed and outside to control amplitude
