...
BackButton::BackButton(const char * aCameraName, unsigned int aDrawRenderOrder) :Button(aCameraName, aDrawRenderOrder)
{
}

BackButton::BackButton(Scene * apScene, std::string aName, Vector3 aPos, Mesh * apMesh, ShaderProgram * apShader,
...
void BackButton::OnButtonPressed()
{
	...
	if (sceneManager != nullptr)
	{
		...
		sceneManager->PopAndDeleteScene(false);
	}
}
